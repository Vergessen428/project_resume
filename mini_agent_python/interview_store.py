...
V1 intentionally keeps the candidate's interview material in one local JSON file
instead of introducing a database before the product workflow is validated.
"""
